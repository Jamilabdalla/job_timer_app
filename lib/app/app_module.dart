...
class AppModule extends Module {
  ...
  List<Bind> get binds => [
        ...
        // ProjectRepository depends on Database
        Bind.lazySingleton<ProjectRepository>(
            (i) => ProjectRepositoryImpl(database: i())),
        // ProjectService depends on ProjectRepository
  ...
  List<ModularRoute> get routes => [
        ...
        // App: module Project => submodule Register => submodule New Project
        ModuleRoute('/register', module: ProjectModule()),
      ];
}
